...
INSERT INTO "new_Client" ("active", "address", "businessNumber", "contactName", "createdAt", "email", "entityType", "fileNumber", "fiscalYearEnd", "folderPath", "hstApplicable", "hstFrequency", "id", "incorporationDate", "incorporationDocumentsReceived", "incorporationJurisdiction", "legalName", "notes", "onboardingStatus", "payrollApplicable", "payrollFrequency", "phone", "qbPasswordEncrypted", "remitterType", "reviewComplete", "reviewYears", "tenantId", "threeMonthEligible", "updatedAt") SELECT "active", "address", "businessNumber", "contactName", "createdAt", "email", "entityType", "fileNumber", "fiscalYearEnd", "folderPath", "hstApplicable", "hstFrequency", "id", "incorporationDate", "incorporationDocumentsReceived", "incorporationJurisdiction", "legalName", "notes", "onboardingStatus", "payrollApplicable", "payrollFrequency", "phone", "qbPasswordEncrypted", "remitterType", "reviewComplete", "reviewYears", "tenantId", "threeMonthEligible", "updatedAt" FROM "Client";
DROP TABLE "Client";
