...
INSERT INTO "new_Client" ("active", "address", "businessNumber", "createdAt", "email", "entityType", "fileNumber", "fiscalYearEnd", "folderPath", "hstApplicable", "hstFrequency", "id", "incorporationDate", "incorporationJurisdiction", "legalName", "notes", "onboardingStatus", "payrollApplicable", "payrollFrequency", "phone", "qbPasswordEncrypted", "remitterType", "reviewComplete", "reviewYears", "tenantId", "threeMonthEligible", "updatedAt") SELECT "active", "address", "businessNumber", "createdAt", "email", "entityType", "fileNumber", "fiscalYearEnd", "folderPath", "hstApplicable", "hstFrequency", "id", "incorporationDate", "incorporationJurisdiction", "legalName", "notes", "onboardingStatus", "payrollApplicable", "payrollFrequency", "phone", "qbPasswordEncrypted", "remitterType", "reviewComplete", "reviewYears", "tenantId", "threeMonthEligible", "updatedAt" FROM "Client";
DROP TABLE "Client";
...
-- Data migration: rename the existing "Filed" status to "Filed/Completed"
-- for all FilingObligation rows. The status enum was extended in code to
-- include the new value.
UPDATE "FilingObligation" SET "status" = 'Filed/Completed' WHERE "status" = 'Filed';
